/**
  ******************************************************************************
  * @file    gd32103e_eval.h
  * @author  MCU SD
  * @version V1.0.0
  * @date    26-Dec-2014
  * @brief   GD32103E_EVAL's Leds, Keys and COM ports hardware resources defines.
  ******************************************************************************
  */
  
/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __GD32F10X_GD32F103E_EVAL_H
#define __GD32F10X_GD32F103E_EVAL_H
...
/** @addtogroup GD32103E_EVAL
  * @{
  */
      
/** @addtogroup GD32103E_EVAL_LOW_LEVEL
  * @{
  */ 
...
/* Exported constants --------------------------------------------------------*/
/** @defgroup GD32103E_EVAL_LOW_LEVEL_Exported_Constants
  * @{
  */ 

/** 
  * @brief  Define for GD32103E_EVAL board
  */

/** @addtogroup GD32103E_EVAL_LOW_LEVEL_LED
  * @{
  */
#define LEDn                             4
...
#define DOWN_KEY_GPIO_CLK                RCC_APB2PERIPH_GPIOF
#define DOWN_KEY_EXTI_LINE               EXTI_LINE4
#define DOWN_KEY_EXTI_PORT_SOURCE        GPIO_PORT_SOURCE_GPIOF
#define DOWN_KEY_EXTI_PIN_SOURCE         GPIO_PINSOURCE4
#define DOWN_KEY_EXTI_IRQn               EXTI4_IRQn

/**
 * @brief Down push-button
 */  
#define UP_KEY_PIN                       GPIO_PIN_5
#define UP_KEY_GPIO_PORT                 GPIOF
#define UP_KEY_GPIO_CLK                  RCC_APB2PERIPH_GPIOF
#define UP_KEY_EXTI_LINE                 EXTI_LINE5
#define UP_KEY_EXTI_PORT_SOURCE          GPIO_PORT_SOURCE_GPIOF
#define UP_KEY_EXTI_PIN_SOURCE           GPIO_PINSOURCE5
#define UP_KEY_EXTI_IRQn                 EXTI9_5_IRQn
...
#endif /* __GD32F10X_GD32F103E_EVAL_H */
/**
  * @}
  */ 
