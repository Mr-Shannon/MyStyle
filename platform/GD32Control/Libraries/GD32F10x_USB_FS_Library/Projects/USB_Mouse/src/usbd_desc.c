...
#define USBD_PID                     0x0289

#define USBD_LANGID_STRING           0x0409
#define USBD_MFC_STRING              "GD32Microelectronics"
#define USBD_PRODUCT_STRING          "GD32 USB Mouse in FS Mode"
#define USBD_CONFIGURATION_STRING    "USB Mouse Config"
#define USBD_INTERFACE_STRING        "USB Mouse Interface"
