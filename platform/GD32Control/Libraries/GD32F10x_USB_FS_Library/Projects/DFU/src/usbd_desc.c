/**
  ...
  * @version V1.0.0
  * @date    26-Dec-2014
  * @brief   USB descriptors and string formating method
  ******************************************************************************
  */ 
...
#define USBD_MFC_STRING               "GigaDevice Inc"
#define USBD_PRODUCT_STRING           "GD32 DFU in FS Mode"
#define USBD_CONFIGURATION_STRING     "USB DFU Config"
#define USBD_INTERFACE_STRING         "USB DFU Interface"
